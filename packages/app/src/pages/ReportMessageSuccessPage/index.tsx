...
type Props = {
  navigation: StackNavigationProp<NavStackParamList, "reportmessagesuccess">;
};

const ReportMessageSuccessPage: FunctionComponent<Props> = ({ navigation }) => {
  return (
...
export default ReportMessageSuccessPage;
